...
const AuthenticatedAdmin = ({ user, header, children }) => {
            ...
            >
                ...
                <nav className="flex-1 p-2 space-y-1">
                    ...
                    >
                        ...
                        {!isCollapsed && <span>Countries</span>}
                    </Link>
                    ...
                    <Link
                        href={route("admin_profile.edit")}
                        className={`
                             flex items-center gap-2 p-2 rounded-lg transition-colors
                             ${
                                 route().current("admin_profile.edit")
                                     ? "bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-400"
                                     : "text-gray-700 dark:text-gray-300 hover:bg-green-50 dark:hover:bg-green-900/30 hover:text-green-600 dark:hover:text-green-400"
                             }
                             ${isCollapsed ? "justify-center" : ""}
