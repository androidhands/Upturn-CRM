      ...
      <AuthenticatedAdminLayout
         ...
         header={
            <div className='flex justify-between items-center'>
               <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Companies</h2>
               <Link className="bg-emerald-500 py-1 px-3 text-white rounded shadow transition-all hover:bg-emerald-600"
                  href={route('company.create')}>Add New</Link>
            </div>
         }
      >
                              ...
                              {companies.data.map(company => (
                                 ...
                                 <tr key={company.id}
                                    ...
                                    <td className="px-3 py-2 text-nowrap">
                                       <Link href={route("company.edit", company.id)} className="text-blue-600 dark:text-blue-500 hover:underline mx-1">
                                          Edit
                                       </Link>
                                       <button onClick={e => deletecompany(company)} className="text-red-600 dark:text-red-500 hover:underline mx-1">
                                          Delete
                                       </button>
                                    </td>
