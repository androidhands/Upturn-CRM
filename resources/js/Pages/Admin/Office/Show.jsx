...
export default function Show({ auth, office, company }) {

   const breadcrumbs = [
      { name: company.name, href: route('company.show', company.id) },
      { name: 'Offices', href: route('office.index', company.id) },
      { name: office.name, href: route('office.show', [company.id, office.id]) },
                  ...
                  <div className="p-6 text-gray-900 dark:text-gray-100">
                     <div className="overflow-auto">
                        <div className="grid gap-1 grid-cols-2 mt-2">
                           ...
                           <div>
                              <div>
                                 <label className="font-bold text-lg">Office ID</label>
                                 <p className="mt-1">{office.id}</p>
                              </div>
                              <div className="mt-4">
                                 <label className="font-bold text-lg">Office Name</label>
