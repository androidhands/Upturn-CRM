...
{
  public function customApiReponse($data = null, $error = null, $success)
  {
    $array = [
      'success' => $success,
      'result' => $data,
    ...
    return response($array, Response::HTTP_OK)->setStatusCode(Response::HTTP_OK, Response::$statusTexts[Response::HTTP_OK]);
  }
  ...
  public function returnError($errNum, $msg)
  {
    ...
    return response($array)->setStatusCode(Response::HTTP_UNPROCESSABLE_ENTITY, Response::$statusTexts[Response::HTTP_NOT_FOUND]);
  }
  /* 
